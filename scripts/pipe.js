class Pipe {
    constructor() {
        ...
        //append to div
        $("#pipes").append("<div id='pipe" + this.id_top + "' class='pipe' style='left:" + this.x + "px;height:" + this.top_border + "px;top:0;'>");
        $("#pipes").append("<div id='pipe" + this.id_low + "' class='pipe' style='left:" + this.x + "px;height:" + this.low_border + "px;bottom:0px;'>");
    }
